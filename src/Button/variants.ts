...
const PRIMARY_DEFAULT = ({ colorVariants }: any) => ({
  ...BUTTON_DEFAULT,
...
const PRIMARY_STYLE = (props: any) => ({ ...PRIMARY_DEFAULT(props) })

const LARGE_STYLE = (props: any) => ({
...
const POSITIVE_STYLE = ({ colorVariants }: any) => ({
  ...BUTTON_DEFAULT,
  backgroundColor: colorVariants.buttonColor ?? 'statusSuccess',
  color: 'white'
})

const LINK_DEFAULT = ({ colorVariants }: any) => ({
  ...BUTTON_DEFAULT,
...
const LINK_STYLE = (props: any) => ({
  ...LINK_DEFAULT(props),
  color: props.colorVariants.buttonColor ?? 'accent'
})

const LINK_POSITIVE_STYLE = (props: any) => ({
  ...LINK_DEFAULT(props),
